...
`assets/ui/<category>/<name>@<scale>.png`; the generator is
`scripts/generate_hud_assets.py`. The generated assets are deterministic and
...
dimensions, hashes, generator version, review result, and intended use in
[`ASSET_LEDGER.md`](ASSET_LEDGER.md).
